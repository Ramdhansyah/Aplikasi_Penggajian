...
<table class="table table-bordered table-striped mt-2">
    <tr>
        ...
        <th class="text-center">Tj. Transaport</th>
    ...
    <?php $no=1; foreach($jabatan as $j) : ?>
        <tr>
            ...
            <td>
                <center>
                    <a href="<?php echo base_url('admin/dataJabatan/updateData/'.$j->id_jabatan) ?>" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Update" ><i class="fas fa-edit"></i></a>
