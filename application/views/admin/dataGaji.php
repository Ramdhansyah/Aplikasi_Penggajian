...
<div class="card mb-3">
    ...
    <div class="card-body">
       ...
       <form class="form-inline">
        <div class="form-groub mb-2">
            <label for="staticEmai12">Bulan: </label>
        ...
        <div class="form-groub mb-2 ml-5">
    ...
    ?>
        ...
        <?php if(count($gaji) > 0) { ?>
            <a href="<?php echo base_url('admin/dataPenggajian/cetakGaji?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success
             mb-2 ml-3" ><i class="fas fa-print "> 
            </i>Cetak Daftar Gaji</a>
    ...
    <div class="table-responsive">
        ...
        <i class = "fas fa-info-circle"></i>Data absensi kosong, 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Data gaji masih kosong, silahkan input absensi terlebih 
        dahulu pada bulan dan tahun yang anda pilih.
      </div>
