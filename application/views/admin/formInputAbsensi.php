...
<h1 class="h3 mb-0 text-gray-800"><?php echo $title ?></h1>
    ...
    <div class="card-body">
       <form class="form-inline">
        ...
        <i class="fas fa-eye"></i> Generate</button>
   ...
   <button class="btn btn-success mb-3" type="submit" name="submit" value="submit">Simpan</button>
    <table class="table table-bordered table-striped">
      ...
      <?php $no=1; foreach($input_absensi as $a) : ?>
        ...
        class="form-control" value="<?php echo $bulantahun ?> ">
        <input type="hidden" name="nik[]" 
        class="form-control" value="<?php echo $a->nik ?> ">
        <input type="hidden" name="nama_pegawai[]" 
        class="form-control" value="<?php echo $a->nama_pegawai ?> ">
        <input type="hidden" name="jenis_kelamin[]" 
        class="form-control" value="<?php echo $a->jenis_kelamin ?> ">
        <input type="hidden" name="nama_jabatan[]" 
        class="form-control" value="<?php echo $a->nama_jabatan ?> ">
           ...
           class="form-control" value="0"></td>
           <td> <input type="number" name="alfa[]" 
           class="form-control" value="0"></td>
