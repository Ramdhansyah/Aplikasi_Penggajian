...
<div class="card mx-auto" style="width: 35%">
    ...
    <div class="card-body">
        ...
        <div class="form-groub row">
            <label for="inputPassword" 
            class="col-sm-3 col-form-label">Nama Pegawai</label>
            <div class="col-sm-9">
        ...
        <button style="width:100%" type="submit" class="btn btn-primary"><i class="fas fa-print"></i>Cetak Slip Gaji</button><br>
