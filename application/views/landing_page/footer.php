...
<script src="<?php echo base_url('assets/landing_page/vendor/swiper/swiper-bundle.min.js') ?>"></script>
<script src="<?php echo base_url('assets/landing_page/vendor/waypoints/noframework.waypoints.js')?>"></script>
